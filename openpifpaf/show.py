...
class KeypointPainter(object):
    ...
    def _draw_skeleton(self, ax, x, y, v, *, color=None):
        ...
        if self.skeleton is not None:
            # self.skeleton 是骨架的链接顺序，-1是从0开始
            # connection 是一个(2,)的数组,表示从a关节连接到b关节
    ...
    # keypoint_sets 传入的是 data.py 中的 coordinates,即各个关节点的坐标
